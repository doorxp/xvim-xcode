...
- (void)printf:(const char *)arg1 arguments:(va_list)arg2;
...
- (void)setMacroNamesAndValues:(id)arg1 arguments:(va_list)arg2;
...
+ (id)dvt_errorWithPOSIXErrorCode:(int)arg1 messageFormat:(id)arg2 arguments:(va_list)arg3;
...
- (BOOL)dvt_writeFormat:(id)arg1 arguments:(va_list)arg2;
